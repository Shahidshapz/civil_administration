...
public class ViewVillages extends AppCompatActivity {
RecyclerView recyclerView;
List<viewvillage>villagelist;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_villages);
        ...
        Call<List<viewvillage>> call=apiService.villageview("view_village");
        call.enqueue(new Callback<List<viewvillage>>() {
            ...
            public void onResponse(Call<List<viewvillage>> call, Response<List<viewvillage>> response) {
                ...
                VillageAdapter VA=new VillageAdapter(getApplicationContext(),villagelist);
