...
import com.example.villageoffie.adapter.TradeAdapter;
...
public class TradeAppliedList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trade_applied_list);
        ...
        Call<List<viewuserapplication>> call = apiService.appview("getTrade");
        call.enqueue(new Callback<List<viewuserapplication>>() {
            ...
            public void onResponse(Call<List<viewuserapplication>> call, Response<List<viewuserapplication>> response) {
                ...
                TradeAdapter AA = new TradeAdapter(getApplicationContext(), applist);
