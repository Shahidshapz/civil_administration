...
public class ViewBirthApp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_birth_app);
        ...
        aname.setText(":\t" + sp.getString("btime",""));
...
//                appid=response.body().getAppId();
    ...
    private void makeDecision() {
        ...
        Call<login> call = apiinterface.checkuserApproval("ApprovalBirth", category,appid,opinion.getText().toString());
