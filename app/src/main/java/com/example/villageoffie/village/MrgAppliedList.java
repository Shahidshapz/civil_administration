...
public class MrgAppliedList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mrg_applied_list);
        ...
        Call<List<viewuserapplication>> call=apiService.appview("getmrg");
        call.enqueue(new Callback<List<viewuserapplication>>() {
            ...
            public void onResponse(Call<List<viewuserapplication>> call, Response<List<viewuserapplication>> response) {
                ...
                MrgAdapter AA=new MrgAdapter(getApplicationContext(),applist);
